            ...
            <div>
              ...
              >
                ...
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M12.48 10.92v3.28h7.84c-.24 1.84-.853 3.187-1.787 4.133-1.147 1.147-2.933 2.4-6.053 2.4-4.827 0-8.6-3.893-8.6-8.72s3.773-8.72 8.6-8.72c2.6 0 4.813.947 6.44 2.453l2.253-2.253C18.973 1.48 16.04 0 12.48 0 5.613 0 0 5.613 0 12.48s5.613 12.48 12.48 12.48c3.6 0 6.333-1.187 8.52-3.453 2.253-2.253 2.947-5.453 2.947-8.12 0-.8-.067-1.547-.187-2.28H12.48z" />
                </svg>
              </a>
            </div>
