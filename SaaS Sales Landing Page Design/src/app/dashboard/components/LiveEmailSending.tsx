...
import { Mail, Server, User, Globe, CheckCircle2 } from "lucide-react";
            ...
            <AnimatePresence>
              {packets.map((packet) => (
                <motion.div
                  ...
                  style={{ x: 0 }} // Reset for motion to handle from 0 to container width (handled by left:0 and x:100% logic usually requires container width knowledge, but here '100%' of parent is fine if parent is the line)
                  onAnimationComplete={() => {
                     // Optionally remove packet from state here if needed, but we slice in useEffect
                  }}
                >
